...
<Guid("31ec29d7-a6ce-4b1c-a19a-00eaebda54a8")> _
<ComVisible(True)> _
<SwAddin( _
...
#Region "UI Methods"
    Public Sub AddCommandMgr()
        ...
        icons(0) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.toolbar20x.png", thisAssembly)
        icons(1) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.toolbar32x.png", thisAssembly)
        icons(2) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.toolbar40x.png", thisAssembly)
        icons(3) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.toolbar64x.png", thisAssembly)
        icons(4) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.toolbar96x.png", thisAssembly)
        icons(5) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.toolbar128x.png", thisAssembly)

        mainIcons(0) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.mainicon_20.png", thisAssembly)
        mainIcons(1) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.mainicon_32.png", thisAssembly)
        mainIcons(2) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.mainicon_40.png", thisAssembly)
        mainIcons(3) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.mainicon_64.png", thisAssembly)
        mainIcons(4) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.mainicon_96.png", thisAssembly)
        mainIcons(5) = iBmp.CreateFileFromResourceBitmap("SwVBAddin1.mainicon_128.png", thisAssembly)
